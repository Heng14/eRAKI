...
from raki_3d_sq_concat_espirit_5layers_caipi7_ellip_joint_allecho import *
...
def run(debug_path='debug_fig_acs_ks3/debug_fig_sq_concat_espirit_24-24-256_3d_Rx3Ry3_caipi7_ellip_joint_allecho_reg'):
    ...
    acs_out1 = np.load('../meas_data_after-espirit/acs_24_24_256_3d_ks3/k1.npy') #(240 ,30, 256), (30, 30, 256))
    acs_out1 = np.expand_dims(acs_out1, axis=-1)
    acs_out2 = np.load('../meas_data_after-espirit/acs_24_24_256_3d_ks3/k2.npy') #(240 ,30, 256), (30, 30, 256))
    acs_out2 = np.expand_dims(acs_out2, axis=-1)
    acs_out3 = np.load('../meas_data_after-espirit/acs_24_24_256_3d_ks3/k3.npy') #(240 ,30, 256), (30, 30, 256))
    acs_out3 = np.expand_dims(acs_out3, axis=-1)
    acs_out = np.concatenate((acs_out1, acs_out2, acs_out3), axis=-1)
    ...
    kdata_coils0_np1 = np.load('../meas_data_after-espirit/acs_24_24_256_3d_ks3/k1_full_samesens.npy') # data used for comparision
    kdata_coils0_np1 = np.expand_dims(kdata_coils0_np1, axis=-1)
    kdata_coils0_np2 = np.load('../meas_data_after-espirit/acs_24_24_256_3d_ks3/k2_full_samesens.npy') # data used for comparision
    kdata_coils0_np2 = np.expand_dims(kdata_coils0_np2, axis=-1)
    kdata_coils0_np3 = np.load('../meas_data_after-espirit/acs_24_24_256_3d_ks3/k3_full_samesens.npy') # data used for comparision
    kdata_coils0_np3 = np.expand_dims(kdata_coils0_np3, axis=-1)
    kdata_coils0_np = np.concatenate((kdata_coils0_np1, kdata_coils0_np2, kdata_coils0_np3), axis=-1)
    #print (kdata_coils0_np.shape)
    #raise
    ...
    kdata_coils0 = np.transpose(kdata_coils0_np, (1,0,2,3))
