...
import time
import os
from raki_epti_cbc_caipi_kt10_5layers import *
...
def process_one(kdata, kdata_ref, acs_out, mask, sens_resize, debug_path='debug_fig_sq'):
    ...
    show_raki_results(kdata_ref, sens_resize, debug_path, name_image)
    #return rmse

def run(debug_path='debug_fig_epti_cbc_32-80-16_Rx3_caipi-kt10'):
    ...
    dt5 = sio.loadmat('../epti_data_after-polycompress/acs_32_80_16/sens_resize.mat') # polyfit full sens map

    sens_resize0 = dt5['sens_resize_full']
    ...
    sens_resize = np.transpose(sens_resize0,(3,1,2,0))
    ...
    process_one(kdata_coils, kdata_coils0, acs_out, mask, sens_resize, debug_path=debug_path)
