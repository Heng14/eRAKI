        ...
        for ind_c in range(ACS_out_dim_Z):
            ...
            for ind_acc_x in range(Rx_fill):
                ...
                for ind_acc_y in range(Ry_fill):
                    ...
                    target[0,:,:,:,ind_acc_y+ind_acc_x*Ry_fill+ind_c*Ry_fill*Rx_fill] = ACS_out[0,target_x_start:target_x_end + 1, target_y_start:target_y_end +1,target_t_start:target_t_end + 1,ind_c];
        ...
        for ind_c in range(0,no_channels):
            ...
            for ind_acc_x in range(Rx_fill):
                ...
                for ind_acc_y in range(Ry_fill):
                    ...
                    kspace_recon[0,target_x_start+x_i:target_x_end + 1:Rx, target_y_start+y_i:target_y_end +1:Ry,target_t_start:target_t_end + 1,ind_c] = res_i[0,:,:,:,ind_acc_y+ind_acc_x*Ry_fill+ind_c*Ry_fill*Rx_fill]
...
def show_raki_results(kdata_ref, debug_path, name_image):
    # ## Results
    # Read the kspace
