...
from raki_3d_sq_concat_espirit_5layers_caipi7_ellip import *
#from raki_3d_sq_concat_espirit_5layers_caipi7_ellip_77 import *
...
def process_one(kdata, kdata_ref, acs_out, debug_path='debug_fig_sq'):
    ...
    kspace_undersampled_zero_filled = kspace_fully_sampled * mask * mask_ellip
...
def run(debug_path='debug_fig_acs_ks3/debug_fig_sq_concat_espirit_24-24-256_3d_Rx3Ry3_caipi7_ellip_reg_k3'):
    ...
    kdata_coils = np.load('../meas_data_np/k3.npy')
    #kdata_coils = np.load('../meas_data_np_gcc/calib_24_24_256_3d_16coils/k1.npy')
    ...
    acs_out = np.load('../meas_data_after-espirit/acs_24_24_256_3d_ks3/k3.npy') #(240 ,30, 256), (30, 30, 256))
