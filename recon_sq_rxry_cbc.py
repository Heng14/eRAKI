...
import os
#from grappa import *
from raki_sq_rxry_cbc import *
#from raki_sq_rxry_cbc_5layers import *
from utils import *
import h5py
#from spark import *
...
def process_one(kdata, kdata0, sens_resize_i, i, debug_path='debug_fig_sq'):
    ...
    name_image = f'{debug_path}/recon_{i}.mat'
    name_weight = f'{debug_path}/weight.mat'

    raki(num_chan, N1, N2, acs_start_index_x, acs_end_index_x, acs_start_index_y, acs_end_index_y, kspace_undersampled_zero_filled, kspace_acs_zero_filled, kspace_coils_acs_out, kspace_acs_cropped, Rx, Ry, debug_path, name_image, name_weight, train_flag=True)
    print (time.time()-start_t)

    rmse = show_raki_results(image_original0, sens_resize_i, debug_path, i, name_image)
    return rmse
...
def show_raki_results_3d(kdata_coils0_np, debug_path0, sens_resize):
    ...
    for i in range(size_t):
        name_image = f'{debug_path0}/recon_{i}.mat'
    ...
    print (coil_images_raki_sub_np.shape)
...
def run(debug_path='debug_fig_acs_ks3/debug_fig_sq_24-24_Rx3Ry3_reg'):
    ...
    os.makedirs(debug_path, exist_ok=True)
    kdata_coils = np.load('../meas_data_256-np/k1.npy')
    print (kdata_coils.shape)
    ...
    #print (kdata_coils0.shape)
    kdata_coils0_np = np.load('../meas_data_after-espirit/acs_24_24_256_3d_ks2/k1_full_samesens.npy') # data used for comparision
    ...
    sens_resize0 = np.load('../meas_data_after-espirit/acs_24_24_256_3d_ks2/sens_resize.npy')
